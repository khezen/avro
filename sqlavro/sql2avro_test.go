...
func TestSQL2AVRO(t *testing.T) {
	...
	var (
		...
		fieldRowsValues = [][]driver.Value{
			...
			[]driver.Value{"date_default", "DATE", "NO", sql.NullString{Valid: true, String: "1970-01-01"}, sql.NullInt64{Valid: false}, sql.NullInt64{Valid: false}, sql.NullInt64{Valid: false}},
			[]driver.Value{"time_default", "TIME", "NO", sql.NullString{Valid: true, String: "00:00:00"}, sql.NullInt64{Valid: false}, sql.NullInt64{Valid: false}, sql.NullInt64{Valid: false}},
	...
	expectedSchemas := []byte(`[{"type":"record","namespace":"dbTest","name":"table1","fields":[{"name":"some_char","type":{"type":"fixed","name":"some_char","size":108}},{"name":"some_varchar","type":"string"},{"name":"some_bolb","type":["null","bytes"]},{"name":"some_int","type":"int","default":18},{"name":"some_bigint","type":"long"},{"name":"some_float","type":"float"},{"name":"some_double","type":"double"},{"name":"some_decimal","type":{"type":"bytes","logicalType":"decimal","precision":8,"scale":12}},{"name":"date","type":{"type":"int","logicalType":"date"}},{"name":"time","type":{"type":"int","logicalType":"time"}},{"name":"datetime","type":{"type":"int","logicalType":"timestamp"}},{"name":"date_default","type":{"type":"int","logicalType":"date"},"default":0},{"name":"time_default","type":{"type":"int","logicalType":"time"},"default":0},{"name":"timestamp","type":{"type":"int","logicalType":"timestamp"}},{"name":"ID","type":"int"},{"name":"title","type":"string"},{"name":"body","type":"bytes"},{"name":"content_type","type":["null","string"],"default":"text/markdown; charset=UTF-8"},{"name":"post_date","type":{"type":"int","logicalType":"timestamp"}},{"name":"update_date","type":["null",{"type":"int","logicalType":"timestamp"}]},{"name":"reading_time_minutes","type":["null",{"type":"bytes","logicalType":"decimal","precision":3,"scale":1}]}]}]`)
